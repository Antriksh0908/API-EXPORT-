...
export const INITIAL_INQUIRIES: BuyerInquiry[] = [
  ...
  },
  {
    ...
    message: 'Good morning Pema, we run 2 locations in Boulder and Denver. Looking for approximately 100-120 singing bowls ranging from 5 inches up to 14 inches with strikers and ring cushions. What volume discount tier can you extend for wire transfer 50% deposit?\n\nThanks,\nSarah',
    time: '2 hours ago',
    unread: false,
